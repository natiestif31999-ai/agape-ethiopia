...
export const translations: Record<Locale, TranslationDictionary> = {
  en: {
    ...
    "uploadSignedAgreementDescription": "Share your organization details and upload the signed PDF so the Agape team can review it.",
    ...
    "loading": "Loading...",
    "liveDashboard": "Welcome to Agape",
  ...
  om: {
    ...
    "navigation.agapeRegistration": "Agape Galmee",
    "agapeMenu": "Agape Menu",
